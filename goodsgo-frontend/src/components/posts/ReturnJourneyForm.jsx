...
export default function ReturnJourneyForm({
  ...
  const buildFormData = (values) => {
    ...
    fd.append('post_type', 'return_journey');
    ...
    fd.append('remaining_capacity_kg', String(values.remaining_capacity_kg));
    ...
    <form onSubmit={handleSubmit(handleFormSubmit)} noValidate className="space-y-6">
      ...
      <section>
        ...
        <p className="mb-3 text-xs text-gray-500">
          Heading back empty? Offer your remaining vehicle capacity on the return trip.
        </p>
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <LocationAutocomplete
                id="rj_origin"
                label="Currently at / departing from"
      ...
      <section>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <Input
            id="rj_capacity"
            label="Remaining capacity (kg)"
            type="number"
            min="1"
            step="0.5"
            placeholder="e.g. 500"
            error={errors.remaining_capacity_kg?.message}
            helperText="How much cargo can you still take?"
            {...register('remaining_capacity_kg')}
          />
        </div>
      </section>
      ...
      <section>
        ...
        <Textarea
          ...
          placeholder="Type of goods you can carry, any restrictions, timing flexibility..."
          rows={3}
