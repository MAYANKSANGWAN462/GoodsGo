...
export default function PublicProfilePage() {
  ...
  return (
    <>
      ...
      {/* Reviews section */}
      <div>
        {/* Section heading — frosted so it reads against the night scene */}
        <div className="flex items-center gap-2 mb-4 bg-surface/80 backdrop-blur-sm rounded-xl px-4 py-3">
